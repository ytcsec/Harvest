          ...
          {step === 2 && attested && (
            <div className="space-y-5">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="bg-rose-50/60 border border-rose-100 rounded-2xl p-4 text-xs text-rose-900 space-y-1.5">
                ...
                <div className="bg-emerald-50/60 border border-emerald-100 rounded-2xl p-4 text-xs text-emerald-900 space-y-2">
                  ...
                  <div>{t("create.statement", { n: form.thresholdTons || 0 })}</div>
                  <div>
              ...
              {zk && (
                <div className="bg-emerald-50 border border-emerald-100 rounded-xl p-4 flex items-start gap-3">
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="text-xs text-emerald-800 font-mono mt-1 break-all">
